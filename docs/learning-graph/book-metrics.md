...
| 3 | MicroSims | 30 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 21 / 21 | Recommended | Chapters with a quiz.md (210 questions total) |
| 6 | Chapter References | 21 / 21 | Recommended | Chapters with references.md (210 references total) |
| 7 | Glossary Terms | 500 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 192,369 | Required | Words across student-facing markdown |
...
| Equations | 51 | 36 | LaTeX expressions (inline and display) |
| Total Words | 192,369 | 121,243 | Words in markdown files |
| Links | 422 | 232 | Hyperlinks in markdown format |
| Equivalent Pages | 791 | 507 | Estimated pages (250 words/page + visuals) |
